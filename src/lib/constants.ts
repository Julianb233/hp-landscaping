...
export const SERVICE_AREAS = [
  ...
  },
  {
    ...
    county: "San Diego County",
    description: "Premium landscaping services for Rancho Bernardo's master-planned communities and estates.",
    population: "48K+",
    featured: false,
    image: "/images/areas/poway.jpg",
  },
  {
    ...
    name: "Solana Beach",
    county: "San Diego County",
    description: "Coastal landscaping expertise for Solana Beach homes and businesses.",
    population: "13K+",
    featured: false,
    image: "/images/areas/del-mar.jpg",
  },
  {
    ...
    name: "Imperial Beach",
    county: "San Diego County",
    description: "Beachside landscaping solutions for Imperial Beach's coastal properties.",
    population: "27K+",
    featured: false,
    image: "/images/areas/coronado.jpg",
  },
  {
    ...
    name: "Lemon Grove",
    county: "San Diego County",
    description: "Quality landscaping services for Lemon Grove residents and businesses.",
    population: "27K+",
    featured: false,
    image: "/images/areas/la-mesa.jpg",
  },
  {
    ...
    name: "Lakeside",
    county: "San Diego County",
    description: "Rural and residential landscaping expertise for the Lakeside community.",
    population: "21K+",
    featured: false,
    image: "/images/areas/santee.jpg",
  },
  {
    ...
    name: "Fallbrook",
    county: "San Diego County",
    description: "Serving Fallbrook's avocado country with expert landscaping and irrigation services.",
    population: "32K+",
    featured: false,
    image: "/images/areas/escondido.jpg",
  },
  {
    ...
    county: "San Diego County",
    description: "Luxury estate landscaping for Rancho Santa Fe's prestigious properties.",
    population: "3K+",
    featured: false,
    image: "/images/areas/del-mar.jpg",
  },
  {
    ...
    name: "Bonita",
    county: "San Diego County",
    description: "Professional landscaping services for Bonita's beautiful neighborhoods.",
    population: "12K+",
    featured: false,
    image: "/images/areas/chula-vista.jpg",
  },
